...
export class Currency {
   ...
   */
  public static convertCurrency(amountInUSD: number, to: string) {
  ...
  */
  public static convertToUSD(amountInLocalCurrency: number, from: string) {
   ...
   */
  public static getCurrencyRates(): Promise<IRates> {
    return this.getXML()
      .then(data => {
  ...
  public static getRate(from: string, to: string) {
